...
public class GoapAgent : MonoBehaviour
{
    ...
    public Dictionary<SubGoal, int> goals = new Dictionary<SubGoal, int>(); // Lista de metas
    public GoapAction currentAction; // Ação atual
    GoapPlanner planner; // Planejadpr (a criar)
    Queue<GoapAction> actionQueue; // Fila de ações
    SubGoal currentGoal; // Meta atual
    bool invoked = false;
    ...
    {
        GoapAction[] goapActions = gameObject.GetComponents<GoapAction>();
    ...
    void LateUpdate()
    {
        ...
        {
            // 0 agente possui um path e chegou no destino?
        ...
        if (planner == null || actionQueue == null)
        {
            ...
            // Usamos o ling para sortir a lista por grau de prioridade
